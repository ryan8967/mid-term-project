<template>
  ...
  <div class="products">
    <ProductCard v-for="prod in formattedProducts" :key="prod._id" :id="prod._id" :image_url="prod.image_url" :name="prod.name"
...
export default {
  ...
  methods: {
    fetchProducts() {
      ...
      let url = 'http://127.0.0.1:8000/api/products/?sub_category=行動裝置';
